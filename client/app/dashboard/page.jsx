...
const projects = [
  {
    id: "Assa3s47",
    name: "Portfolio",
    icon: `https://api.dicebear.com/9.x/bottts/svg?seed=${Math.random()}`,
    status: "Active",
    repo: "https://github.com/alwinsunil/portfolio",
  },
  {
    id: "ssam3s47",
    name: "Article plus",
    icon: `https://api.dicebear.com/9.x/bottts/svg?seed=${Math.random()}`,
    status: "Failed",
    repo: "https://github.com/alwinsunil/article-plus",
  },
];
