    ...
    <div className="flex min-h-[calc(100vh-7rem)] flex-col gap-1 px-4 py-3 md:px-10">
      ...
      <div className="mb-4 flex divide-x border-y py-2.5">
        <a
          ...
          className="group flex w-fit items-center gap-2 px-2 font-sans text-xs font-medium text-black"
          target="_blank"
          rel="noreferrer"
        >
          ...
          <p className="w-fit rounded-full border border-blue-200 bg-blue-50 px-2 font-sans text-xs font-semibold text-blue-600">
            {project?.branch}
          </p>
        </a>
      </div>
